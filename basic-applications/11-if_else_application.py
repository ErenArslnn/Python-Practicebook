...
start = int(input("To start avg consumption calculator please enter '1'. To start avg student point calculator enter '2'. To exit enter '0': "))
while(start == 1):
    ...
    start = int(input("To calculate again enter '1'. To swich to Avg student point calculator enter '2'. To exit enter '0': "))
...
while(start == 2):
    ...
    start = int(input("To calculate again enter '2'. To swich to Avg fuel consuption calculator enter '2'. To exit enter '0': "))
